# Generated by Django 2.0.10 on 2019-02-04 10:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('country', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='mildb.Country')),
                ('ethnic_mem', models.ManyToManyField(blank=True, help_text='Select or add EPR Group', null=True, related_name='ethnic_target', to='mildb.Ethnic', verbose_name='Ethnic Membership')),
                ('ethnic_purp', models.ManyToManyField(blank=True, help_text='Select or add EPR Group', null=True, related_name='ethnic_mem', to='mildb.Ethnic', verbose_name='Ethnic Purpose')),
                ('ethnic_targ', models.ManyToManyField(blank=True, help_text='Select or add EPR Group', null=True, to='mildb.Ethnic', verbose_name='Ethnic Target')),
                ('government_creator', models.ManyToManyField(blank=True, to='mildb.GovernmentCreator', verbose_name='Creating Government Institution')),
                ('government_link', models.ManyToManyField(to='mildb.GovernmentLink')),
                ('membership', models.ManyToManyField(to='mildb.MemberCharacteristic')),
            ],
            options={
                'verbose_name': 'PGM',
        ...
        migrations.AddField(
            model_name='pgag',
            name='post_ucdp',
            field=models.ManyToManyField(blank=True, related_name='prior_group', to='mildb.UCDP', verbose_name='UCDP Actor ID of successor rebel group'),
        ),
        migrations.AddField(
            model_name='pgag',
            name='predecessor_group',
            field=models.ManyToManyField(blank=True, null=True, to='mildb.PGAG'),
        ),
        migrations.AddField(
            model_name='pgag',
            name='prior_ucdp',
            field=models.ManyToManyField(blank=True, to='mildb.UCDP', verbose_name='UCDP Actor ID of former rebel group'),
        ),
        migrations.AddField(
            model_name='pgag',
            name='purpose',
            field=models.ManyToManyField(to='mildb.Purpose'),
        ),
        migrations.AddField(
            model_name='pgag',
            name='relative_benefit',
            field=models.ManyToManyField(blank=True, null=True, to='mildb.RelativeBenefit', verbose_name='Relative Benefit'),
        ),
        migrations.AddField(
            model_name='pgag',
            name='successor_group',
            field=models.ManyToManyField(blank=True, null=True, related_name='successors', to='mildb.PGAG'),
        ),
        migrations.AddField(
            model_name='pgag',
            name='support_types',
            field=models.ManyToManyField(to='mildb.Support', verbose_name='Types of material support'),
        ),
        migrations.AddField(
            model_name='pgag',
            name='supporters',
            field=models.ManyToManyField(blank=True, null=True, related_name='sponsors', to='mildb.Country', verbose_name='State sponsors'),
        ),
        migrations.AddField(
            model_name='pgag',
            name='target',
            field=models.ManyToManyField(blank=True, null=True, to='mildb.Target'),
        ),
        migrations.AddField(
            model_name='pgag',
            name='termination_types',
            field=models.ManyToManyField(blank=True, to='mildb.TermType', verbose_name='Termination Types'),
        ),
        migrations.AddField(
            model_name='pgag',
            name='type_violence',
            field=models.ManyToManyField(blank=True, null=True, to='mildb.TypeViolence', verbose_name='Types of Violence'),
        ),
        migrations.AddField(
            model_name='operation',
            name='group',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='mildb.PGAG'),
        ),
        migrations.AddField(
            model_name='evidence',
            name='group',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='backing', to='mildb.PGAG'),
        ),
    ]
